 ...
 */
public class SilverlightStatScreen extends BaseStatisticsScreen {
    ...
    private SilverlightStatRequest mRequest;
    private SilverlightStatResponse mData;
    ...
    protected SourceLine.LineData getLineData(int position){
        final SilverlightStat data = mData.getStats().get(position);
        final SilverlightStat total = mData.getTotals();
        final SilverlightStat max = mData.getMax();
    ...
    protected void load(){
        ...
        mRequest = Webservice.getSilverlightStat(!needRefresh(), new BaseRequest.Listener<SilverlightStatResponse>() {
            @Override
            public void onResponse(SilverlightStatResponse response) {
