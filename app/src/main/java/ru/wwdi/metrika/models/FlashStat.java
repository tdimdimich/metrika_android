 ...
 */
@Table(name = "FlashStat")
public class FlashStat extends Model {

    @Column(name="response")
    private FlashStatResponse response;
    ...
    public FlashStatResponse getResponse() {
        return response;
    }

    public void setResponse(FlashStatResponse response) {
