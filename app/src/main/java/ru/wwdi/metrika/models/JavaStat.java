 ...
 */
@Table(name = "JavaStat")
public class JavaStat extends Model {

    @Column(name="response")
    private JavaStatResponse response;
    ...
    public JavaStatResponse getResponse() {
        return response;
    }

    public void setResponse(JavaStatResponse response) {
